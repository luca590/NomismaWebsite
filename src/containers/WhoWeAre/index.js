...
class WhoWeAre extends Component {
  render () {
    return (
      <Content>
        <h1>• World experts/leaders in both institutional and academic finance and economics</h1>
        <h1>• Passion for entrepreneurship and financial technology (fintech)</h1>
        <h1>• Understand ramifications of blockchain</h1>
        <h1>• Equip with ability to execute on ideas</h1><br/><br/>
        <ProfileCard
          name='Dimitrios Kavvathas'
          subtitle='Chief Investment Officer at Harmony Advisors Limited'
          picURL='assets/img/pic_dimitrios.png'
        >
          Dimitrios joined Goldman Sachs in London in 2001 and moved to Hong Kong in 2009. He was promoted to Managing Director in 2005 and was invited to join the partnership in 2008. He served in various senior positions during his career, including co-Head of Asia Pacific Securities Division Distribution (FICC, Equities, Corporate Origination Sales & Structuring), serving on the Asia Pacific Securities Division Operating Committee, the Asia Pacific Risk Committee, the Global Firmwide New Activity and Asset & Liability Committees as well as the Goldman Sachs (Asia) L.L.C. Board of Directors. He started his career in Fixed Income and held positions in interest rates, FX, commodities, credit derivatives, structured finance, equity derivatives, high yield and convertible bonds, as well as covering and interacting with all clients groups, including asset managers, financial institutions, pension funds, corporates, sovereigns and HNWIs.
          Dimitrios joined VTB Capital in 2013, where he served as Head of Global Markets – Asia Pacific, responsible for fixed income and equities sales, trading and origination as well the China, India and Vietnam bank branches’ market and credit risks. In 2014, he joined Noble Group as co-Head of Financial Services, responsible for Structured Finance, Commodity Enhanced Finance, Customer Coverage, Capital & Origination, while simultaneously overseeing the Group’s technology and strat./quant. teams. He served on the Group’s Risk Committee as well as the Global Credit Committee – the governance body monitoring credit, market and operational risks across physical commodities and financial markets. He jointly oversaw the Group’s principal credit, market risk investing, as well as the Group’s balance sheet/liquidity management and strategic stakeholder engagement efforts.
          Dimitrios joined Harmony Advisors Limited, an SFC Type 1, 2, 4 and 9 licensed multi-family office/asset manager, in 2016 as Chief Investment Officer. He is currently responsible for all investments across Harmony’s discretionary mandates, including a multi-strategy hedge fund, external managed accounts, private equity and other alternative transactions. Furthermore, Dimitrios oversees the firm’s asset allocation framework and the fundamental and quantitative research efforts across all products globally.
        ...
        <ProfileCard
          name='Lauren Cohen'
          subtitle='Professor Lauren H. Cohen
          L.E. Simmons Professor of Business Administration'
          picURL='assets/img/pic_lauren.png'
        >
        ...
        <ProfileCard
          name='Kimon Gomozias'
        >
          Kimon started his career at Goldman Sachs in 2003 before moving to ECM, a boutique fixed income asset manager, in 2004 to work on the development of structured fixed income funds.
        ...
        <ProfileCard
          name='Lucas Gaylord'
          picURL='assets/img/pic_lucas.png'
        >
          Lucas Gaylord is a Global Business and Computer Science double major at Hong Kong University of Science and Technology (HKUST) from the United States. His studies and extracurricular activities have been fully funded by several prestigious scholarships, including the Mr & Mrs Liu Sing Cheong and Wong Po Yuk Scholarship (SBM Global Leadership and Community Engagement), the HKUST Diverse Initiative Scholarship, and the Mainland Experience Scheme Award for Chinese studies. After 4 rigorous years, which often required Lucas to create his own classes and design academic programs where they didn’t previously exist, he will be the first student of HKUST to successfully achieve the dual degree outlined above. 
